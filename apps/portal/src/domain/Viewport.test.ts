...
describe('Viewport', () => {
  ...
  describe('isCreatureVisible', () => {
    ...
    it('should return true for creature partially in viewport', () => {
      ...
      const creature = new Creature(1, 35, 0, 0, 10, 1); // 10m wide, extends to 40
    ...
    it('should return false for creature completely outside viewport', () => {
      ...
      const creature = new Creature(1, 100, 100, 0, 1, 1);
    ...
    it('should account for creature size in visibility check', () => {
      ...
      const creature = new Creature(1, 45, 0, 0, 12, 1);
    ...
    it('should handle creatures with zero size', () => {
      ...
      const creature = new Creature(1, 0, 0, 0, 0, 0);
    ...
    it('should work with moved camera', () => {
      ...
      const visibleCreature = new Creature(1, 1000, 500, 0, 1, 1);
      const invisibleCreature = new Creature(2, 0, 0, 0, 1, 1);
  ...
  describe('cullCreatures', () => {
    it('should return only visible creatures', () => {
      ...
      const creatures = [
        new Creature(1, 0, 0, 0, 1, 1),     // Visible (center)
        new Creature(2, 35, 25, 0, 1, 1),   // Visible (near edge)
        new Creature(3, 100, 100, 0, 1, 1), // Invisible (far away)
        new Creature(4, -100, 0, 0, 1, 1)   // Invisible (far away)
      ];
    ...
    it('should return empty array when no creatures visible', () => {
      ...
      const creatures = [
        new Creature(1, 1000, 1000, 0, 1, 1),
        new Creature(2, -1000, -1000, 0, 1, 1)
      ];
    ...
    it('should return all creatures when all visible', () => {
      ...
      const creatures = [
        new Creature(1, 0, 0, 0, 1, 1),
        new Creature(2, 10, 10, 0, 1, 1),
        new Creature(3, -10, -10, 0, 1, 1)
      ];
