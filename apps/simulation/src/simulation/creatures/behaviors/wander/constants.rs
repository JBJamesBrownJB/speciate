...
pub const COMFORT_RADIUS: f32 = 10.0; // Territory core radius where creature explores freely (meters)
pub const BLEND_CENTER: f32 = 20.0; // Distance where wander/homeward forces are 50/50 (meters)
pub const MAX_WANDER_DISTANCE: f32 = 30.0; // Hard limit for excursions from home (meters)
