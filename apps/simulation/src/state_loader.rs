...
pub struct SpawnSection {
    pub random_creatures: usize,
    #[serde(default)]
    pub area_x_min: Option<f32>,
    #[serde(default)]
    pub area_x_max: Option<f32>,
    #[serde(default)]
    pub area_y_min: Option<f32>,
    #[serde(default)]
    pub area_y_max: Option<f32>,
    #[serde(default)]
...
"#;
        ...
        assert_eq!(state.spawn.random_creatures, 500);
        assert_eq!(state.spawn.area_x_min, Some(10.0));
        assert_eq!(state.spawn.size_min, Some(0.5));
...
"#;
        ...
        assert_eq!(state.spawn.random_creatures, 1000);
        assert_eq!(state.spawn.area_x_min, None);
        assert_eq!(state.spawn.area_x_max, None);
        assert_eq!(state.spawn.size_min, None);
        assert_eq!(state.spawn.size_max, None);
    ...
    fn test_load_nonexistent_file() {
        ...
        assert!(matches!(result.unwrap_err(), StateLoadError::FileNotFound(_)));
    }
