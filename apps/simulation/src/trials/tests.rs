//! Trial and Spec schema tests - extracted from mod.rs for maintainability.
//!
//! These tests cover:
//! - TrialConfig TOML deserialization (legacy schema)
//! - SpawnPattern variants (Single, Grid, Circle)
//! - WorldConfig and BoundaryOverride
//! - SpecConfig (Sprint 19 schema)
//! - Assertion types
